...
nep_name = "/home/fhy/GPUMD-master/potentials/nep/nep89_20250409/nep89_20250409.txt"

all_points_plot = 'combine'                                      

sel_des_method = 'before'                                      
...
def main():
    ...
    if len(sys.argv) < 3:
        ...
        print("Usage: python select_pick_structure_subjournal.py all <method> # Observe the position of all points")

        print("Usage: python select_pick_structure_subjournal.py select <method> min_distance_1/max_select_1 min_distance_2/max_select_2 ......")

        print("Usage: python select_pick_structure_subjournal.py pick <method> x1_start x1_end y1_start y1_end x2_start x2_end y2_start y2_end ......")
